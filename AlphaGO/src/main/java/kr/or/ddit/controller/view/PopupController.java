...
public class PopupController {
	...
	public String registPopup(PopupRegistCommand popupCommand, MultipartHttpServletRequest request
			, RedirectAttributes rttr) throws Exception{
		String url="redirect:/popup/list.go";
		
		//file저장 -> List<AttachVO>
		String savePath = this.popupUploadPath;
		List<PopAttachVO> attachList = 
				GetPopAttachesByMultiFileAdapter.save(popupCommand.getUploadFile(), savePath);
		//DB
