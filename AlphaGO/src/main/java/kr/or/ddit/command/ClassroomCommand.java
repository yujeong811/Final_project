...
public class ClassroomCommand implements Serializable{
	...
	private List<MultipartFile> oldPicture;
	...
	public List<MultipartFile> getOldPicture() {
		return oldPicture;
	}
	public void setOldPicture(List<MultipartFile> oldPicture) {
