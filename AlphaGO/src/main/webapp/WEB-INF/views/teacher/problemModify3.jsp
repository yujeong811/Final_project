...
<input type="hidden" id="code"value="${problem.problemCode}">
	...
	<form role="form" class="form-horizontal" action="problemModifygo.go"
				...
				<div class="card">
					<div class="card-body" style="padding: 15px;">
						...
						<div class="d-flex justify-content-start">
							...
							<div>
								<label class="form-label" for="formrow-firstname-input"
									style="font-weight: bold;">문제 형식</label> 	<select class="form-select col-md-3" id="processSelect"
							...
							<div style="margin: 0px 35px 0px 35px;">
								<label class="form-label" for="formrow-firstname-input"
									style="font-weight: bold;">문제 유형</label>	<select class="form-select col-md-3" id="processSelect"
						...
						<button type="button" class="btn btn-soft-success" id="ign"
							...
							<textarea class="form-control bg-light text-dark"
								...
								style="height: 120px; margin-bottom: 10px" name="problemContent">${problem.problemContent}</textarea>
						...
						<div class="form-floating">
							<textarea class="form-control bg-light text-dark"
								...
								style="height: 120px" name="problemAnswer">${problem.problemAnswer}</textarea>
							<label for="floatingTextarea2" class="text-dark"
						...
						<div class="form-floating">
							<textarea class="form-control bg-light text-dark"
								...
								style="height: 120px" name="problemSolution">${problem.problemSolution}</textarea>
							<label for="floatingTextarea2" class="text-dark"
			...
			<div class="col-6">
				<div class="card" style="height: 748px;">
					<div class="card-body" style="padding: 15px;">
						...
						<div class="mailbox-attachment-icon has-img view${problem.problemCode}" id="pictureView2"
