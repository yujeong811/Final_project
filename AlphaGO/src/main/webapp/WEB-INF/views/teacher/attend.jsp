		...
		<div class="card-body">
			...
			<div class="dropdown" style="margin-bottom: 5px;">
				...
				<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
					<li><a class="dropdown-item" href="<%=request.getContextPath()%>/teacher/list.go">전체</a></li>
					<li><a class="dropdown-item" href="<%=request.getContextPath()%>/teacher/list.go?month=1">1개월</a></li>
					<li><a class="dropdown-item" href="<%=request.getContextPath()%>/teacher/list.go?month=3">3개월</a></li>
				</ul>
			</div>
					...
					<tbody>
						...
						<tr>
							...
							<td>
							  ...
							  <c:if test="${attend.attendanceStatus eq 1 }"><h4><span class="badge bg-primary">출근</span></h4></c:if>
							  <c:if test="${attend.attendanceStatus eq 2 }"><h4><span class="badge bg-danger">결근</span></h4></c:if>
