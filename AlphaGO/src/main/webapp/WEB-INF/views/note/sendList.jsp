    ...
    <div class="col-12">
       <div class="email-leftbar card">
          ...
          <div class="mail-list mt-4">
              ...
              <a href="#" class="active"><i class="bx bx-mail-send font-size-16 align-middle me-2"></i>보낸쪽지함</a>
          </div>
        ...
        <div class="email-rightbar mb-3">
            ...
            <div class="card">
                ...
                <ul class="message-list">
	            		...
	            		<c:forEach items="${dmList }" var="dm" varStatus="vs">
	     					<li data-code="${dm.dmCode }">
		                        <div class="col-mail col-mail-1">
		                            ...
		                            <a href="detail.go?code=${dm.dmCode }&from=sendList" class="title">${dm.dmReceiver }</a>
		                        ...
		                        <div class="col-mail col-mail-2">
		                            <a href="detail.go?code=${dm.dmCode }&from=sendList" class="subject">${dm.dmTitle }</a>
	            	...
	            	<c:if test="${empty dmList }" >
	            	  <li>
	            	     <p style="text-align: center; font-size: 16px; font-weight: bold; color: gray;">보낸 메일이 없습니다.</p>
	            	  </li>
	            	</c:if>
                </ul>
            </div><!-- card -->
