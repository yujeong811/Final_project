...
<body>
	<div class="d-flex justify-content-between mb-2">
		<h5 style="font-weight: bold;">
			<i class="uil-unlock-alt" style="margin-right: 10px;"></i>강사 등록
		</h5>
	...
	<div class="row">
		<form role="form" class="form-horizontal" action="registTeacher.go" method="post" enctype="multipart/form-data">								
		<div class="col-sm-4" style="padding: 0px;">
			<div class="card" >
				<div class="card-body">
						...
						<div class="d-flex align-items-start mt-3 mb-3">
							...
							<label for="inputFile"  style="margin-left:90px;" class=" btn btn-secondary btn-sm btn-flat input-group-addon">파일선택</label>
							  ...
							  <button onclick="upload_go();"
							  	type="button" class="btn btn-primary" style="margin-left:10px; height: 28px; line-height: 10px; width: 55px;">등록</button>
					...
					<div class="mb-3">
						<label class="form-label" style="font-weight: bold; margin-right: 21px;">과목</label>
									<div class="col-sm-9  input-group-sm">								
								
							<select  style="" class="form-select" name="subject" 
					...
					<div class="mb-2">
						...
						<div class="mt-3 mb-3">
						<label class="form-label"style="font-weight: bold; margin-right: 35px;">시급</label>
						<div class="col-sm-9 input-group-sm">								
								<input class="form-control"  type="text" name="timepay" class="form-control" id="timepay"
										placeholder=""
										/>
							</div>
						<hr style="margin: 5px 0 0 0;">
					...
					<div class="card">
						<div class="card-header d-flex align-items-center">
							...
							<div class="flex-grow-1">
								<h5 class="card-title">&nbsp;&nbsp;&nbsp;출 퇴근 시간 정보</h5>
							</div>
						</div>
						<div class="card-body">
							<div class="mb-2">
								<div class="d-flex align-items-start">
									<label class="form-label"  style="font-weight: bold; margin-right: 83px; margin-top: 4px;">출근 시간</label>
									<input id="attendTime" name="attendTime" class="form-control" type="text" style="width:150px; height: 30px;"  />
									
								</div>
							</div>
							<div>
							  <div class="d-flex align-items-start" style="text-align: center;">
								<label class="form-label" style="font-weight: bold; margin-top: 3px; margin-right: 83px;">퇴근 시간</label>
								<input name="outTimes"id="outTimes" type="text" class="form-control" style="width: 150px; height: 30px;">
							  </div>
							</div>
						</div>
