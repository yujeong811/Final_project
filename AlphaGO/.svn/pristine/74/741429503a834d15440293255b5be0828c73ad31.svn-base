...
//		}
	...
	public Map<String, Object> getAllExamList(String id, SearchCriteria cri) throws SQLException {
		...
		PageMaker pageMaker = new PageMaker();
		pageMaker.setCri(cri);
		pageMaker.setTotalCount(examTotalList2.size());
		 Map<String, Object> dataMap=new HashMap<String, Object>();
	...
	//시험코드로 오답가져오기/
	@Override
	public List<WrongVO> getExamCodeWrong(String examCode,String id) throws SQLException {
		// TODO Auto-generated method stub
		return teacherDAO.getExamCodeWrong(examCode,id);
	}
