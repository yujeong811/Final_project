...
function stuSgo(t){
	...
	$.ajax({
	    ...
	    success : function(res){
			...
			str+='		<th style="font-weight: bold;width:80px;padding:6px;">일자</th>' ;
			str+='		<th style="font-weight: bold;width:120px;padding:6px;">시험명</th>';
			str+='		<th style="font-weight: bold;width:80px;padding:6px;">화작</th>';
			str+='		<th style="font-weight: bold;padding:6px;">문법</th>';
			str+='		<th style="font-weight: bold;padding:6px;">독서</th>';
			str+='		<th style="font-weight: bold;padding:6px;">문학</th>';
			str+='		<th style="font-weight: bold;padding:6px;">점수</th>' ;
			str+='		<th style="font-weight: bold;padding:6px;">성취도</th>';
			str+='	</tr>';
			str+=' </thead>';
			str+='<tbody>';
			var tkor1=0;
					  ...
					  <div class="row" style="height:295px;">
					    <div class="col-sm-5">
					     <div id="chart-area"></div>
						  <div id="acd_kor_line_chart" class="apex-charts"></div>
					    </div>
					    <div class="col-sm-7" >
