...
//        danList.add(pr);
	...
	public ResponseEntity<List<ProblemVO>>wrongExamProblem(HttpServletRequest request,String examCode,String id) throws Exception{
		...
		//시험코드로 오답 가져오기.
		List<WrongVO>wrongList=service.getExamCodeWrong(examCode,id);
