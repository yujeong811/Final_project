								...
								<div class="col-md-12" style="margin-top: 10px;">
									<div class="card">
										<div class="row">
											<div class="col-sm-12" style="padding-top: 5px;">
												<span class="badge badge-soft-primary"
													style="font-size: 1.0em;"> 수업 상세</span>
										...
										<table class="table"
											...
											<tr>
												<td scope="col"
													style="background-color: #86a8d9; color: white;">수업명</td>
											...
											<tr class="">
												...
												<td scope="col"
													style="background-color: #86a8d9; color: white;">학년</td>
											...
											<tr class="">
												<td scope="col"
													style="background-color: #86a8d9; color: white;">정원</td>
												...
												<td scope="col"
													style="background-color: #86a8d9; color: white;">금액</td>
												<td>
													<div>
										...
										<div class="row">
											<div class="col-sm-5" style="float: left;">
												...
												<div class="col-sm-12"
													...
													<div class="col-sm-12"style="height:180px;overflow: auto;">
											...
											<div class="col-sm-6" style="float: right;">
												...
												<div class="card-body">
													<table class="table" id="teacherDetail"
														...
														<tr>
															<th colspan="4"
																style="background-color: #86a8d9; color: white;">자격증</th>
														</tr>
														<tr>
															<td colspan="4">-</td>
														</tr>
										...
										<div class="col-md-3" style="float: left;">
											...
											<div>
												<table class="table"
													...
													<tr>
														<td
															style="background-color: #86a8d9; color: white; width: 50%;">시작일</td>
								...
								<div class="col-md-12">
									...
									<div class="card" style="margin-bottom: 0;">
										<table class="table"
											...
											<tr>
												<th style="background-color: #86a8d9; color: white;">수준</th>
