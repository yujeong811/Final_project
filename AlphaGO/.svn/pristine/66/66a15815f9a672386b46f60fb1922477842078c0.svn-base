...
var dsubject
$(function(){
	dsubject=$('#subjectSelect :selected').val();

	classpogSearchgo('<%=request.getContextPath()%>');
})
...
$(function(){
	...
	if("${problem.picture}"==""){
		$('#pictureView1g').css("display","none");
		$('#lpm').val("객관식");
		$('#lpm').text("객관식");
		
	}else{
		
		$('#ign1g').css('display',"none");
		$('#imginsert1g').css('display','');
		$('#pictureView1g').css('display','');
		$('#lpm').val("객관식");
		$('#lpm').text("객관식");
	...
	$('#pro1g').css('display','none');
	$('#pro1j').css('display','');
	if("${problem.picture}"==""){
		$('#pictureView1j').css("display","none");
		$('#lpm').val("객관식");
		$('#lpm').text("객관식");
		
	}else{
		
		$('#ign1j').css('display',"none");
		$('#imginsert1j').css('display','');
		$('#pictureView1j').css('display','');
		$('#lpm').val("주관식");
		$('#lpm').text("주관식");
	}
	</c:if>
	if($('#pictureView1g').css('display')!="none"||$('#pictureView1j').css("display")!="none"){
...
<body>
${problem.lproblem }
<form role="form" class="form-horizontal" action="problemjModify.go" method="post" id="probleminsertgo">
<input type="hidden" id="code"value="${problem.problemCode}"name="problemCode">
				...
				<div class="card-body" style="padding: 15px;">
					...
					<div class="form-floating">
						<textarea class="form-control bg-light text-dark"
							...
							style="height: 630px;" name="problemPrint"cols="20" rows="30">${jimoon}</textarea>
				...
				<div class="card-body" style="padding: 15px;">
						...
						<div class="d-flex" style="margin-bottom: 10px;">
							...
							<div>
								...
								<button type="button" class="btn btn-soft-secondary"
									style="height: 30px; line-height: 5px; margin-right: 5px;"onclick="resetgo();"id="c1">취소 </button>
						...
						<div class="d-flex justify-content-start">
							...
							<div>
								...
								<select class="form-select col-md-3" id="processSelect"
									style="width: 90px; height: 30px; font-size: 0.7em;"name="lproblem1">
									
									<option value="객관식" selected="selected" id="lpm">객관식</option>
					...
					<div id="pro1g">
						<div class="form-floating">
							<button type="button" class="btn btn-soft-success" id="ign1g"
									...
									<div class="input-group input-group-sm">
										...
										<div class="col-sm-6">
											<button type="button" class="btn btn-soft-danger"
												...
												onclick="cancelgo();"id="c2">취소</button>
								...
								<div class="mailbox-attachment-icon has-img view${problem.problemCode}" id="pictureView1g"
								...
								<textarea class="form-control bg-light text-dark"
									...
									style="height: 80px; margin-bottom: 10px"name="problemContent1g">${problem.problemContent}</textarea>
								<label for="floatingTextarea2" class="text-dark"
								...
								<div class="col-11">
									<div class="form-floating bg-light">
										<input type="text" class="form-control bg-light text-dark"
											...
											style="height: 30px; width: 100%;" name="none1g" value="${problem.none}"> <label
								...
								<div class="col-11">
									<div class="form-floating bg-light">
										<input type="text" class="form-control bg-light text-dark"
											...
											style="height: 30px; width: 100%;" name="ntwo1g" value="${problem.ntwo}"> <label
											for="floatingTitle" class="text-dark"
											style="font-weight: bold; line-height: 4px;">②</label>
									</div>
								</div>
								...
								<div class="col-11">
									<div class="form-floating bg-light">
										<input type="text" class="form-control bg-light text-dark"
											...
											style="height: 30px; width: 100%;"name="ntree1g" value="${problem.ntree}"> <label
											for="floatingTitle" class="text-dark"
											style="font-weight: bold; line-height: 4px;">③</label>
									</div>
								</div>
								...
								<div class="col-11">
									<div class="form-floating bg-light">
										<input type="text" class="form-control bg-light text-dark"
											...
											style="height: 30px; width: 100%;"name="nfour1g" value="${problem.nfour}"> <label
											for="floatingTitle" class="text-dark"
											style="font-weight: bold; line-height: 4px;">④</label>
									</div>
								</div>
								...
								<div class="col-11">
									<div class="form-floating bg-light">
										<input type="text" class="form-control bg-light text-dark"
											...
											style="height: 30px; width: 100%;"name="nfive1g"value="${problem.nfive}"> <label
											for="floatingTitle" class="text-dark"
											style="font-weight: bold; line-height: 4px;">⑤</label>
									</div>
								</div>
							...
							<div class="form-floating" style="height: 100px; overflow: auto;">
								<textarea class="form-control bg-light text-dark"
									...
									style="height: 100px"name="problemSolution1g">${problem.problemSolution}</textarea>
					...
					<div id="pro1j" style="display:none;">
							<div class="form-floating">
								...
								<div class="mailbox-attachment-icon has-img view${problem.problemCode}" id="pictureView1j"
									style="border: 1px solid green; height: 150px; width: 70%; margin: 0 auto; margin-bottom: 10px; display: none;">
								</div>
								
								<textarea class="form-control bg-light text-dark"
									placeholder="Leave a comment here" id="problemContent1j"
									style="height: 120px; margin-bottom: 10px"name="problemContent1j">${problem.problemContent}</textarea>
								<label for="floatingTextarea2" class="text-dark"
									style="font-weight: bold;">문제 </label>
							</div>
							<div class="form-floating">
								<textarea class="form-control bg-light text-dark"
									...
									style="height: 120px"name="problemAnswer1j">${problem.problemAnswer}</textarea>
								<label for="floatingTextarea2" class="text-dark"
							...
							<div class="form-floating">
								<textarea class="form-control bg-light text-dark"
									...
									style="height: 120px"name="problemSolution1j">${problem.problemSolution}</textarea>
								<label for="floatingTextarea2" class="text-dark"
									style="font-weight: bold;">해설 </label>
...
<!-- 								</div> -->
									<select class="form-select col-md-3" id="processSelect"
									 ...
									 <c:forEach items="${subAreaList}" var="subarea">
								      ...
								      <option value="${problem.sano}">${problem.saname}</option>
...
<!-- 								지문나오는 곳 -->
						...
						<div class="col-6">
							<div style="font-weight: bold;">[문제]</div>
								<div class="mailbox-attachment-icon has-img view${problem.problemCode}" id="pictureViewPre"
									style="border: 1px solid green; height: 150px; width: 70%; margin: 0 auto; margin-bottom: 10px; display: none;">
								</div>
	...
	<form role="imageForm" action="#" method="post"
