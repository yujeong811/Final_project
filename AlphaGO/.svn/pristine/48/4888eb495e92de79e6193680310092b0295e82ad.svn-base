...
function wrongGo2(){
	 $.ajax({
			...
			type : 'get',
			data : {"examCode":examCode2,"id":id2},
...
<body>
	...
	<div class="row">
		<div class="col-7" style="padding-right:0px;">
			<div class="card" style="height:776px;">
								...
								<table class="table text-center table-hover"
									...
									<tbody>
									 <c:forEach items="${examList}" var="exam">
										<tr id="ex${exam.examCode}" class="exid${exam.stu}" onclick="worongGo(this);">
...
<div class="card-footer">
	...
	<ul id="nav-ul" class="pagination justify-content-center m-0">
		...
		<div class="col-5">
			<div class="card">
				<div class="card-body" style="padding: 15px;">
					<h5 style="margin: 10px 0px 15px 10px;">[<span style="font-weight:120;"id="stuname">이름</span>] 원생 답안지</h5>
