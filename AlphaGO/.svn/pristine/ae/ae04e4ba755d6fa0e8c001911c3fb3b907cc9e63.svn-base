	...
	<table class="table table-hover" style="text-align: center;margin:0;vertical-align: middle;">
		...
		{{#each .}}
			<tr onclick="getStudentScore(this);">
				...
				<td style="padding:5px;"><button class="btn btn-warning" type="button" onclick="event.cancelBubble=true;OpenWindow('<%=request.getContextPath()%>/sscore/detail.go?id={{id}}','성적 정보',1000,900)">성적</button></td>
			</tr>
		{{/each}}
		</tbody>
	</table>
	...
	<table class="table table-hover" style="text-align: center;margin:0;vertical-align:middle;">
		...
		{{#each .}}
			<tr onclick="getStudentScore(this);">
				...
				<td style="padding:5px;">{{grade}}</td>
				<td style="padding:5px;">{{setDouble acheive}}</td>
				<td style="padding:5px;"><button class="btn btn-warning" type="button" onclick="OpenWindow('<%=request.getContextPath()%>/sscore/detail.go?id={{id}}','성적 정보',1000,900)">성적</button></td>
			</tr>
		{{/each}}
		</tbody>
	</table>
